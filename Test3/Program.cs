...
namespace Test3
{
    class Program
    {
        ...
        {
            int muts = (int)Math.Floor((double)( (double)g.actions.Count * (double)( (double)mutations / 100 ) ));
            bool onlyAdd = false;
            ...
            for ( var m = 0; m < muts; m++ )
            {
                ...
                {
                    case 0: // Add
                        AdvancedMutationClasses.Action na = new AdvancedMutationClasses.Action();
                        switch ( r.Next(4) )
                        {
                            case 0:
                                na.action = Actions.Action.M_DOWN;
                                break;
                            case 1:
                                na.action = Actions.Action.M_UP;
                                break;
                            case 2:
                                na.action = Actions.Action.M_LEFT;
                                break;
                            case 3:
                                na.action = Actions.Action.M_RIGHT;
                                break;
                        }
                        g.actions.Add(na);
                        break;
